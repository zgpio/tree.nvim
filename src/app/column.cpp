...
unordered_map<string, unordered_map<string, QString>> extensions =  {
    { "styl"    , {{"icon", ""}, {"color" , gui_colors["green"]       } }},
    { "sass"    , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "scss"    , {{"icon", ""}, {"color" , gui_colors["pink"]        } }},
    { "htm"     , {{"icon", ""}, {"color" , gui_colors["darkOrange"]  } }},
    { "html"    , {{"icon", ""}, {"color" , gui_colors["darkOrange"]  } }},
    { "slim"    , {{"icon", ""}, {"color" , gui_colors["orange"]      } }},
    { "ejs"     , {{"icon", ""}, {"color" , gui_colors["yellow"]      } }},
    { "css"     , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "less"    , {{"icon", ""}, {"color" , gui_colors["darkBlue"]    } }},
    { "md"      , {{"icon", ""}, {"color" , gui_colors["yellow"]      } }},
    { "markdown", {{"icon", ""}, {"color" , gui_colors["yellow"]      } }},
    { "rmd"     , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "json"    , {{"icon", ""}, {"color" , gui_colors["beige"]       } }},
    { "js"      , {{"icon", ""}, {"color" , gui_colors["beige"]       } }},
    { "mjs"     , {{"icon", ""}, {"color" , gui_colors["beige"]       } }},
    { "jsx"     , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "rb"      , {{"icon", ""}, {"color" , gui_colors["red"]         } }},
    { "php"     , {{"icon", ""}, {"color" , gui_colors["purple"]      } }},
    { "py"      , {{"icon", ""}, {"color" , gui_colors["yellow"]      } }},
    { "pyc"     , {{"icon", ""}, {"color" , gui_colors["yellow"]      } }},
    { "pyo"     , {{"icon", ""}, {"color" , gui_colors["yellow"]      } }},
    { "pyd"     , {{"icon", ""}, {"color" , gui_colors["yellow"]      } }},
    { "coffee"  , {{"icon", ""}, {"color" , gui_colors["brown"]       } }},
    { "mustache", {{"icon", ""}, {"color" , gui_colors["orange"]      } }},
    { "hbs"     , {{"icon", ""}, {"color" , gui_colors["orange"]      } }},
    { "conf"    , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "ini"     , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "yml"     , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "yaml"    , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "bat"     , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "jpg"     , {{"icon", ""}, {"color" , gui_colors["aqua"]        } }},
    { "jpeg"    , {{"icon", ""}, {"color" , gui_colors["aqua"]        } }},
    { "bmp"     , {{"icon", ""}, {"color" , gui_colors["aqua"]        } }},
    { "png"     , {{"icon", ""}, {"color" , gui_colors["aqua"]        } }},
    { "gif"     , {{"icon", ""}, {"color" , gui_colors["aqua"]        } }},
    { "ico"     , {{"icon", ""}, {"color" , gui_colors["aqua"]        } }},
    { "twig"    , {{"icon", ""}, {"color" , gui_colors["green"]       } }},
    { "cpp"     , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "cxx"     , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "cc"      , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "cp"      , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "c"       , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "h"       , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "hpp"     , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "hxx"     , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "hs"      , {{"icon", ""}, {"color" , gui_colors["beige"]       } }},
    { "lhs"     , {{"icon", ""}, {"color" , gui_colors["beige"]       } }},
    { "lua"     , {{"icon", ""}, {"color" , gui_colors["purple"]      } }},
    { "java"    , {{"icon", ""}, {"color" , gui_colors["purple"]      } }},
    { "sh"      , {{"icon", ""}, {"color" , gui_colors["lightPurple"] } }},
    { "fish"    , {{"icon", ""}, {"color" , gui_colors["green"]       } }},
    { "bash"    , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "zsh"     , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "ksh"     , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "csh"     , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "awk"     , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "ps1"     , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "ml"      , {{"icon", "λ"}, {"color" , gui_colors["yellow"]      } }},
    { "mli"     , {{"icon", "λ"}, {"color" , gui_colors["yellow"]      } }},
    { "diff"    , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "db"      , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "sql"     , {{"icon", ""}, {"color" , gui_colors["darkBlue"]    } }},
    { "dump"    , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "clj"     , {{"icon", ""}, {"color" , gui_colors["green"]       } }},
    { "cljc"    , {{"icon", ""}, {"color" , gui_colors["green"]       } }},
    { "cljs"    , {{"icon", ""}, {"color" , gui_colors["green"]       } }},
    { "edn"     , {{"icon", ""}, {"color" , gui_colors["green"]       } }},
    { "scala"   , {{"icon", ""}, {"color" , gui_colors["red"]         } }},
    { "go"      , {{"icon", ""}, {"color" , gui_colors["beige"]       } }},
    { "dart"    , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "xul"     , {{"icon", ""}, {"color" , gui_colors["darkOrange"]  } }},
    { "sln"     , {{"icon", ""}, {"color" , gui_colors["purple"]      } }},
    { "suo"     , {{"icon", ""}, {"color" , gui_colors["purple"]      } }},
    { "pl"      , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "pm"      , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "t"       , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "rss"     , {{"icon", ""}, {"color" , gui_colors["darkOrange"]  } }},
    { "fsscript", {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "fsx"     , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "fs"      , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "fsi"     , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "rs"      , {{"icon", ""}, {"color" , gui_colors["darkOrange"]  } }},
    { "rlib"    , {{"icon", ""}, {"color" , gui_colors["darkOrange"]  } }},
    { "d"       , {{"icon", ""}, {"color" , gui_colors["red"]         } }},
    { "erl"     , {{"icon", ""}, {"color" , gui_colors["lightPurple"] } }},
    { "ex"      , {{"icon", ""}, {"color" , gui_colors["lightPurple"] } }},
    { "exs"     , {{"icon", ""}, {"color" , gui_colors["lightPurple"] } }},
    { "eex"     , {{"icon", ""}, {"color" , gui_colors["lightPurple"] } }},
    { "hrl"     , {{"icon", ""}, {"color" , gui_colors["pink"]        } }},
    { "vim"     , {{"icon", ""}, {"color" , gui_colors["green"]       } }},
    { "ai"      , {{"icon", ""}, {"color" , gui_colors["darkOrange"]  } }},
    { "psd"     , {{"icon", ""}, {"color" , gui_colors["darkBlue"]    } }},
    { "psb"     , {{"icon", ""}, {"color" , gui_colors["darkBlue"]    } }},
    { "ts"      , {{"icon", ""}, {"color" , gui_colors["blue"]        } }},
    { "tsx"     , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "jl"      , {{"icon", ""}, {"color" , gui_colors["purple"]      } }},
    { "pp"      , {{"icon", ""}, {"color" , gui_colors["white"]       } }},
    { "vue"     , {{"icon", "﵂"}, {"color" , gui_colors["green"]       } }},
};
// clang-format on
